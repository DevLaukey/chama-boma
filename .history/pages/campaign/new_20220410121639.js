...
export default function NewCampaign() {
  ...
  return (
    <div>
      <Head>
        <title>New Chama</title>
        <meta name="description" content="Create New Chama" />
      ...
      <main>
        <Stack spacing={8} mx={"auto"} maxW={"2xl"} py={12} px={6}>
          ...
          <Stack>
            <Heading fontSize={"4xl"}>Create a New Chama</Heading>
          </Stack>
          <Box
            rounded={"lg"}
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <Stack spacing={4}>
                ...
                <FormControl id="description">
                  <FormLabel>Chama Description</FormLabel>
                  <Textarea
                  ...
                  {wallet.status === "connected" ? (
                    ...
                    <Stack spacing={3}>
                      ...
                      <Alert status="warning">
                        <AlertIcon />
                        <AlertDescription mr={2}>
                          Please Connect Your Wallet First to Create a Chama
                        </AlertDescription>
                      </Alert>
                    </Stack>
                  )}
