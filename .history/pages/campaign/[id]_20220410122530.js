              ...
              <Box mx={"auto"} w={"full"}>
                <SimpleGrid columns={{ base: 1 }} spacing={{ base: 5 }}>
                  <StatsCard
                    ...
                    info={
                      "You must remit at least this much in Wei ( 1 ETH = 10 ^ 18 Wei) to become an chama member"
                    }
                  />
                  <StatsCard
                    title={"Wallet Address of Chama Creator"}
                    stat={manager}
                    info={
                      "The Chama Creator created the chama and can create requests to withdraw money."
                    }
                  />
                  <StatsCard
                    ...
                    stat={requestsCount}
                    info={
                      "A request tries to withdraw money from the contract. Requests must be approved by the Chama members."
                    }
                  />
                  <StatsCard
                    ...
                    stat={approversCount}
                    info={
                      "Number of people who have remitted to the chama account"
                    }
                  />
                </SimpleGrid>
              </Box>
                ...
                >
                  <StatLabel fontWeight={"medium"}>
                    <Text as="span" isTruncated mr={2}>
                      {" "}
                      Chama Target Balance.
                    </Text>
                    <Tooltip
                      label="The balance is how much money is remaining in the chama's account"
                      bg={useColorModeValue("white", "gray.700")}
                      placement={"top"}
                      color={useColorModeValue("gray.800", "white")}
                      fontSize={"1em"}
                    ...
                    <Stack spacing={10}>
                      {wallet.status === "connected" ? (
                        ...
                        <Alert status="warning" mt={4}>
                          <AlertIcon />
                          <AlertDescription mr={2}>
                            Please Connect Your Wallet to Remit
                          </AlertDescription>
                        </Alert>
                      )}
                    </Stack>
