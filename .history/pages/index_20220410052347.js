      ...
      <main className={styles.main}>
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} align={"left"}>
          ...
          <Heading
            ...
            py={6}
          >
            ~Transparent ~Reliable ~Accountable <br />A platform you can trust
          </Heading>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} py={8}>
            <Feature
              ...
              text={"Register your chama on this platform today"}
            />
            <Feature
              icon={<Icon as={FcShare} w={10} h={10} />}
              title={"Share your Chama"}
              text={"Invite desired members to join the chama."}
            />
            <Feature
              icon={<Icon as={FcMoneyTransfer} w={10} h={10} />}
              title={"Invest or Withdraw Funds"}
              text={
                "The funds raised can be withdrawn directly to the recipient when 50% of the chama members approve of the Withdrawal Request."
              }
            />
          </SimpleGrid>
